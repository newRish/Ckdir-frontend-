      ...
      <div className={`${styles.landing} ${mainStyles.landing}`}>
        ...
        <div className={`${styles.container} ${mainStyles.textContainer}`}>
          <div className={`${styles.textContainer} ${mainStyles.mainText}`}>
            <div className={`${styles.landingText} ${mainStyles.landingText}`}>
            ...
            text={
              <div className={styles.container}>
                <div className={styles.label}>
                  Enables you to track your fleet real time. Know where they go,
                  on the go.
                </div>
              </div>
            }
        ...
        <div className={styles.list2}>
          ...
          <AlternateSection
            ...
            text={
              <div className={styles.container}>
                <div className={styles.label}>
                  Enables you to track your fleet real time, giving you complete
        ...
        <div className={styles.list3}>
          ...
          <AlternateSection
            ...
            text={
              <div className={styles.container}>
                <div className={styles.label}>
                  Realtime tracking, fencing, heavily needed for the World where
                  multiple touchpoints is everyday business.
                </div>
              </div>
            }
